...
public class Pemberitahuan_Kemarin_adapter extends RecyclerView.Adapter<Pemberitahuan_Kemarin_adapter.ViewHolder>{
    private ArrayList<Pemberitahuan_model> pemberitahuan; //kalo list pake <>
    private Context context;

    public Pemberitahuan_Kemarin_adapter(ArrayList<Pemberitahuan_model> pemberitahuan) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Pemberitahuan_Kemarin_adapter.ViewHolder(view);
    }
