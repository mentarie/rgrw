...
public class Activity_komunitas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        komunitas.add(new Komunitas_model(4,getResources().getIdentifier("lindungihutan", "drawable", this.getPackageName()),"Lindungi Hutan", "Komunitas Lingkungan", "Yogyakarta", "3000 pengikut"));
        komunitas.add(new Komunitas_model(5,getResources().getIdentifier("logo_komunitas", "drawable", this.getPackageName()),"Pecinta Alam Kaltim", "Komunitas Reboisasi", "Kalimantan Timur", "1051 pengikut"));
        komunitas.add(new Komunitas_model(5,getResources().getIdentifier("logoregrow", "drawable", this.getPackageName()),"ReGrow", "Komunitas Reboisasi", "Yogyakarta", "650 pengikut"));
